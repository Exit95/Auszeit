...
export function AtelierHubScreen() {
  ...
  const menuItems = [
    ...
    },
    {
      ...
      iconFocused: 'gift' as const,
      title: 'Gutscheine',
      subtitle: 'Verkaufte Gutscheine ansehen',
      badge: 0,
    ...
    },
    {
      ...
      iconFocused: 'add-circle' as const,
      title: 'Neue Buchung',
    ...
    },
    {
      ...
      iconFocused: 'airplane' as const,
      title: 'Urlaub & Sperren',
      subtitle: 'Zeiträume ohne Buchung verwalten',
      badge: 0,
      color: colors.info,
    ...
    },
    {
      ...
      title: 'Statistiken',
      subtitle: 'Umsatz, Buchungen, Trends',
      badge: 0,
      color: colors.secondary,
